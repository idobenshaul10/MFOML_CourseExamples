...
class ImageClassifier(pl.LightningModule):
    def __init__(
        ...
        self.model = ViTForImageClassification.from_pretrained(model_name_or_path, num_labels=1000)
        if num_labels == 10:
            self.model.classifier = nn.Linear(768, num_labels)
    ...
    def training_step(self, batch, batch_idx):
        ...
        metric_dict = self.metric(preds, batch['labels'], mode='train')
