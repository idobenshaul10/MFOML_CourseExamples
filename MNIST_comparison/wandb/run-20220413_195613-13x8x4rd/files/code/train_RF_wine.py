...
def predict_WF_RF(rf_model, X, y, X_test, y_test):
	...
	for num_wavelets in tqdm(range(0, 20, 1)):
...
def create_dataset():
	...
	train_red, test_red = train_test_split(red_wine, test_size=0.1, random_state=0)
	train_white, test_white = train_test_split(white_wine, test_size=0.1, random_state=0)
